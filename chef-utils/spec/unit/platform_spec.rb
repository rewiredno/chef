...
RSpec.describe ChefUtils::Platform do
  ...
  PLATFORM_HELPERS = %i{ubuntu? debian_platform? linuxmint? raspbian?}.freeze
  ...
  context "on raspbian 8.0" do
    ...
    it "reports true for #raspbian?" do
  ...
  context "on linuxmint 19.0" do
    ...
    it "reports true for #mint? and #linuxmint?" do
      reports_true_for(:mint?, :linuxmint?)
    end
  end
